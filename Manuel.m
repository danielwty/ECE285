...
for i = 1:10
    ...
    calibrate_line = 10;
    I = zeros(900,900,3);
    I(center(1),center(2),2) = 255;
    I(center(1)-calibrate_line:center(1)+calibrate_line,center(2)-1:center(2)+1,1) = 255; 
    I(center(1)-1:center(1)+1,center(2)-calibrate_line:center(2)+calibrate_line,1) = 255; 
    set(h,'cdata',I);
    drawnow
    pause
    for j = 1:150
